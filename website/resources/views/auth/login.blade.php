...
<body style="height: 100vh; overflow-y: hidden;">
        ...
        <div class="logg" style=" justify-content: center; display: flex; height: 85%; margin-top: 3%;">
            <div class="form">
                ...
                <div class="mb-1 font-light text-base">
                    <h4>If you don't have any account registered, <br>
                        You can <a class="font-bold text-blue-800" href="{{ route('signup')}}">Register here!</a>
                    </h4>
                </div>
                <br>
                <div>
                    <form action="{{ route('login.authenticate') }}" method="post">
                        ...
                        <div class="mb-4 text-sm">
                            ...
                            <input type="text" id="email" name="email" placeholder="Enter your email address"
                                class="text-base sm:text-sm w-full p-2 border-b-2 border-gray-300 hover:border-indigo-300" value="{{ old('email') }}">
                        </div>
                        <div class="mb-4 text-sm">
                        ...
                        <div class="flex justify-end">
                            <div class="text-gray-700 text-xs font-light hover:text-blue-600 hover:underline"><a href="{{route('password.request')}}">Forgot Password?</a></div>
                        </div>
                        <br>
    ...
    <div class="image">
        <div style="height: 97%;
               width: 97%;
               background-image: url({{url('images/Pale.jpg')}});
