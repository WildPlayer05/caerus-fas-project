                ...
                <form action="{{ route('password.email') }}" method="post">
                    ...
                    <div class="mb-4 text-sm">
                        ...
                        <input type="text" id="email" name="email" placeholder="Enter your email address"
                               class="w-full p-2 border-b-2 border-gray-300 hover:border-indigo-300" value="{{ old('email') }}">
                    </div>
                    <br>
                    <div class="flex justify-center">
                        <input type="submit" value="Send Email" class="w-11/12 bg-blue-900 text-white p-2 rounded-full shadow-md cursor-pointer">
                    </div>
                </form>
