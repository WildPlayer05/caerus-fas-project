    ...
    <div class="log">
        ...
        <div class="logg" style=" justify-content: center; display: flex; height: 85%; margin-top: 3%;">
            <div class="form">
                ...
                <br>
                <div>
                    <form action="{{ route('signup.verify.post') }}" method="post">
                        @csrf
                        <div class="mb-4 text-sm">
                            <label for="email" class="font-light">OTP</label>
                            <input type="hidden" name="id" value="{{$id}}">
                            <input type="text" id="otp" name="otp" placeholder="Enter your OTP"
                                class="w-full p-2 border-b-2 border-gray-300 hover:border-indigo-300">
                        </div>
                        <br>
