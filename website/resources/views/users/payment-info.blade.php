...
<main class="h-auto">
    ...
    <div class="lg:mt-20 space-y-8 flex justify-center h-auto">
            ...
            <div class="col-span-3 px-4 py-8 w-full">
                ...
                <form method="post" action="{{route('user.payment')}}">
                    ...
                    <div class="grid grid-cols-1 gap-4 mb-4 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-10 sm:mb-5">
                        <div class="w-full">
                            <label for="cardholderName" class="block mb-2 text-sm font-medium text-gray-900">Insert the name
                                of the card holder</label>
                            <input type="text" name="cardholderName" id="cardholderName"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 disabled:bg-gray-200"
                        ...
                        <div class="w-full">
                            <label for="cardNumber" class="block mb-2 text-sm font-medium text-gray-900">Insert the card number</label>
                        ...
                        <div class="w-full">
                            <label for="expMonth" class="block mb-2 text-sm font-medium text-gray-900">Insert the expiration date</label>
                            <input type="date" name="expMonth" id="expMonth"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 disabled:bg-gray-200"
                                   value="" placeholder="" required>
                            <div class="text-red-500 text-sm">
                                @error('expMonth')
                        ...
                        <div class="w-full">
                            <label for="cvc" class="block mb-2 text-sm font-medium text-gray-900">Insert the CVC</label>
